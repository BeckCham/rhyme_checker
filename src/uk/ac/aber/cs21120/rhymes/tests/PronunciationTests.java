...
public class PronunciationTests {
    ...
    /**
     * Tests that when there's two secondary stressed vowels
     * that the final stressed one is assessed correctly
     */
    @Test
    @Order(70)
    void testFindFinalStressedVowel_twoSecondary() {
        IPronunciation p = new Pronunciation();
        p.add(new Phoneme(Arpabet.W, -1));
        p.add(new Phoneme(Arpabet.ER, 2));   // first secondary stress
        p.add(new Phoneme(Arpabet.K, -1));
        p.add(new Phoneme(Arpabet.B, -1));
        p.add(new Phoneme(Arpabet.EH, 2));   // final secondary stress
        p.add(new Phoneme(Arpabet.N, -1));
        p.add(new Phoneme(Arpabet.CH, -1));
